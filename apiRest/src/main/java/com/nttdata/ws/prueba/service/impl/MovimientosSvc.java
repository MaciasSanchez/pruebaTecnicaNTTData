...
public class MovimientosSvc implements IMovimientosSvc {
	...
	public MovimientosType crearMovimiento(MovimientosType movimientosType) throws BusinessException {
		...
		if (TiposDeMovimiento.RETIRO.equals(movimientosType.getTipoMovimiento())) {
			...
			// movimientosType.setSaldoDisponible((datosCuenta.getSaldoInicial() -
			// Math.abs(movimientosType.getMovimiento()) ));
	...
	public List<MovimientosClienteType> consultarMovimientosPorFechas(Date fechaDesde, Date fechaHasta) {
		return MovimientosConvert
				.listModelToTypeCliente(mvtsRepository.consultarMovimientosPorFechas(fechaDesde, fechaHasta));
	}
	...
	public EstadoCuentaType consultarEstadoCuenta(String numIdentificacion, Date fechaDesde, Date fechaHasta)
		...
		if (datosCliente == null) {
			throw new BusinessException(String.format(
					"El número de identificación: [%s] no se encuentra registrado, por favor verifique el numero.",
		...
		List<MovimientosClienteType> movimientosEfectuados = (List<MovimientosClienteType>) MovimientosConvert
				.listModelToTypeCliente(
						mvtsRepository.consultarMovimientosPorCliente(numIdentificacion, fechaDesde, fechaHasta));
