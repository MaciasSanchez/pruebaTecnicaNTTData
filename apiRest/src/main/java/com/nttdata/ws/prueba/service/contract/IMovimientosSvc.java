...
public interface IMovimientosSvc {
	...
	List<MovimientosType> consultarMovimientosPorCuentaTipoMovimiento(String numeroCuenta,TiposDeMovimiento tipoMovimiento) throws BusinessException;
	List<MovimientosType> consultarMovimientosPorNumeroDeCta(String numCuenta, Date fechaDesde, Date fechaHasta) throws BusinessException;
	List<MovimientosType> consultarMovimientosPorCta(String numCuenta) throws BusinessException;
	List<MovimientosType> consultarMovimientosPorCliente(String numIdentificacion, Date fechaDesde, Date fechaHasta) throws BusinessException;
	...
	List<MovimientosType> consultarMovimientosPorFechas(Date fechaDesde, Date fechaHasta) throws BusinessException;
